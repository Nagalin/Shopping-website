        ...
        <div className='d-flex  justify-content-center align-items-center'
            ...
            <form onSubmit={handleRegister} >
                ...
                <div className="d-flex gap-3 flex-column" style={{ padding: '20px', borderRadius: '10px', backgroundColor: '#F7F7F7' }}>
                    ...
                    <input ref={name} placeholder='Enter your first name'
                    ...
                    <input ref={lastName} placeholder='Enter your last name'
                        ...
                        className="form-control" style={{ width: '400px' }} />
                    <input ref={email} data-testid="password-input"
                        placeholder='Enter your e-mail' required
                        className="form-control" style={{ width: '400px' }} />
                    <input ref={phoneNumber} data-testid="password-input"
                        placeholder='Enter your phone number' required
                        className="form-control" style={{ width: '400px' }} />
                    <input ref={age} data-testid="password-input"
                        placeholder='Enter your age' required
                        className="form-control" style={{ width: '400px' }} />
                    <input ref={address} data-testid="password-input"
