    ...
    return (
        ...
        <NavbarBS className='bg-light shadow-sm mb-4'>
            ...
            <Nav className='ms-auto d-flex align-items-center gap-3'>
                ...
                <Button  data-testid='chat' variant="none"  style={{ width: '3rem', height: '3rem' }} onClick={toggle}>
                <svg 
                ...
                {cartItems.length > 0 &&<Button onClick={openCart} variant="outline-primary" style={{ width: '3rem', height: '3rem' }}>
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 576 512"
                        fill="currentColor"
